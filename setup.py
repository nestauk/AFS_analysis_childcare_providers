...
setup(
    name="afs_analysis_childcare_providers",
    ...
    version="0.1.0",
    description="Data analysis work around childcare providers takeup and the effect of covid on school readiness for early years.",
    author="Nesta",
    license="MIT",
)
